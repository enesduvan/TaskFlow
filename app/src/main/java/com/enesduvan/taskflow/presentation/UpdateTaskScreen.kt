...
fun UpdateTaskScreen(
    ...
    LaunchedEffect(task) {
        viewModel.onTaskNameChange(task.Task)
        viewModel.onTaskDescriptionChange(task.Description)
        viewModel.onSelectedPriorityChange(task.Priority)
    }
...
fun UpdateTaskScreenPreview() {
    TaskFlowTheme {
        UpdateTaskScreen(
            ...
            task = Task(1, "Sample Task", "Sample Description", "Today", "Medium", false)
        )
    }
}